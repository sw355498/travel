...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2021 at 02:40 PM
...
(10, '奇美部落深度旅遊{二}', 8, 900, 0, '採箭筍06.jpg', '奇美部落', '自行前往', '<p>奇美文化導覽（祭典文化、生活文化導覽）</p>\r\n<p>→傳統家屋初體驗（內部解說）</p>\r\n<p>→享用部落風味餐→介紹秀姑巒溪→</p>\r\n<p>Misukap（摸蝦）收蝦籠→</p>\r\n<p>認識麥飯石、撿麥飯石→製作Cifar（傳統器皿）→體驗烹煮石頭火鍋→賦歸</p>', '<p>旅遊時間：若9:00抵達奇美部落～14:00賦歸</p>\r\n                    <p>若10:00抵達奇美部落～15:00賦歸\r\n                   （以此類推）</p>', 3, 0, '山谷裡隱蔽的現代桃花源 整個奇美部落 是一座活的博物館', '奇美部落', '中文', '當天活動多有戶外行程，請來參加學員務必攜帶防曬物品及衣物，穿著長褲和自備環瓶、筷，以及2~3個口罩。', 25, '', 'Filedata635981527821595860.jpg', 'Filedata635983842690221715.jpg', 'Filedata635981527244550846.jpg', 'Filedata635981526062380770.jpg', 'Filedata635983820160038143 (1).jpg'),
...
(13, '走進撒固兒', 8, 1000, 0, '撒固兒1.jpg', '台灣 |  撒固兒部落 ', '自行前往', '10:00 花蓮火車站集合\r\n部落文化祭祀廣場→部落野菜市集→部落廚房→佐倉步道→撒固兒瀑布\r\n', '撒固兒部落周邊許多特色景點，如撒固兒野菜市集、國福養生休閒園區、佐倉步道、撒固兒瀑布等，將在地景點與文化特色相結合，以「健康與休閒」作為旅遊相關產業的發展主軸。積極推廣傳統文化、產業，傳承族群文化並且反應出原住民與自然共存，取材自然山林的文化。\r\n \r\n', 5, 0, '撒固兒部落，舊稱加路蘭，面對太平洋背靠加路蘭山，孕育了豐沛且多樣的人文景象與自然生態。擁有豐富的林相、肥沃的土地、海洋的豐沛資源，使得原住民能於山林、平原、海邊取得各式各類型的生態資源。', '撒固兒部落', '中文', '當天活動多有戶外行程，請來參加學員務必攜帶防曬物品及衣物，穿著長褲和自備環瓶、筷，以及2~3個口罩。', 5, '跟著部落長輩們學習如何在部落過生活，將其視為一個課題，如同修學分，讓日常知識、文化做中學的概念，感受它。', '013(7).jpg', '001(7).jpg', '006(5).jpg', '010(6).jpg', '011(7).jpg'),
